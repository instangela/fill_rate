...
SELECT 
    ds
    , ID_worker_id
    , RV_INT_FUTURE_running_worker_assigneds
    , RV_INT_FUTURE_running_worker_unassigneds
    , RV_INT_FUTURE_running_business_cancels
    , RV_INT_FUTURE_running_auto_cancels
    , RV_INT_FUTURE_running_worker_cancels
    , RV_INT_FUTURE_running_excuse_cancels
    , RV_INT_FUTURE_running_shift_leads
FROM (
SELECT
    ...
    , COALESCE(RV_INT_FUTURE_running_worker_assigneds, 0) AS RV_INT_FUTURE_running_worker_assigneds
    , COALESCE(RV_INT_FUTURE_running_worker_unassigneds, 0) AS RV_INT_FUTURE_running_worker_unassigneds
    , COALESCE(RV_INT_FUTURE_running_business_cancels, 0) AS RV_INT_FUTURE_running_business_cancels
    , COALESCE(RV_INT_FUTURE_running_auto_cancels, 0) AS RV_INT_FUTURE_running_auto_cancels
    , COALESCE(RV_INT_FUTURE_running_worker_cancels, 0) AS RV_INT_FUTURE_running_worker_cancels
    , COALESCE(RV_INT_FUTURE_running_excuse_cancels, 0) AS RV_INT_FUTURE_running_excuse_cancels
    , COALESCE(RV_INT_FUTURE_running_shift_leads, 0) AS RV_INT_FUTURE_running_shift_leads
    FROM (
        SELECT
            psi.ID_worker_id
        ...
        FROM (
            ...
            FROM iw_backend_db.backend_workerlog
            WHERE 
